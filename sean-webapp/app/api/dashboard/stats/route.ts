...
export async function GET(request: NextRequest) {
  try {
    ...
    const userStats = {
      ...
      codexSubmitted: await prisma.knowledgeItem.count({ where: { submittedByUserId: user.id } }),
    ...
    return NextResponse.json({
      system: {
        ...
        codex: {
          total: totalCodexItems,
          approved: approvedCodex,
      ...
      user: userStats,
      codexByDomain: codexByDomain.map(d => ({
