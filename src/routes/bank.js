...
const uploadDir = path.join(__dirname, '../../uploads/bank_attachments');
 ...
 */
router.post('/accounts', authenticate, hasPermission('bank.view'), async (req, res) => {
 ...
 */
router.post('/transactions/:id/attachments', authenticate, hasPermission('bank.view'), upload.single('file'), async (req, res) => {
  const client = await db.getClient();
 ...
 */
router.delete('/attachments/:attachmentId', authenticate, hasPermission('bank.view'), async (req, res) => {
  const client = await db.getClient();
